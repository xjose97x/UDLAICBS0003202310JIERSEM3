...
CREATE TABLE CHANNELS (
    ...
    CHANNEL_CLASS_ID VARCHAR(5) NOT NULL
);
...
ALTER TABLE
    CUSTOMERS
ADD
    CONSTRAINT CUSTOMERS_COUNTRY_FK FOREIGN KEY (COUNTRY_ID) REFERENCES COUNTRIES (COUNTRY_ID);
...
ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_CUSTOMER_FK FOREIGN KEY (CUST_ID) REFERENCES CUSTOMERS (CUST_ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_PRODUCT_FK FOREIGN KEY (PROD_ID) REFERENCES PRODUCTS (PROD_ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_PROMO_FK FOREIGN KEY (PROMO_ID) REFERENCES PROMOTIONS (PROMO_ID);

ALTER TABLE
    SALES
ADD
    CONSTRAINT SALES_TIME_FK FOREIGN KEY (TIME_ID) REFERENCES TIMES (TIME_ID);